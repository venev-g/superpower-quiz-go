...
CREATE TYPE public.question_type AS ENUM ('multiple_choice', 'single_choice', 'rating_scale', 'multiselect');

-- Add question_type column to questions table
ALTER TABLE public.questions 
ADD COLUMN question_type public.question_type DEFAULT 'single_choice';

-- Add rating scale options
ALTER TABLE public.questions 
ADD COLUMN rating_min INTEGER DEFAULT 1,
ADD COLUMN rating_max INTEGER DEFAULT 5,
ADD COLUMN rating_labels JSONB DEFAULT '[]'::jsonb;
